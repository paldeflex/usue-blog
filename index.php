...
<div class="container">
    ...
    <div class="card mb-3 border-0 featured-post mt-4 mb-5 p-3 bg-light-subtle">
        <div class="row g-3">
            <div class="col-md-12 col-lg-6">
                <a href="<?= ROOT_URL ?>single.php?id=<?= $featured['id'] ?>"><img
                            src="assets/images/<?= $featured['thumbnail'] ?>"
            ...
            <div class="col-md-12 col-lg-6">
                <div class="card-body">
                    ...
                    <a href="category-posts.php?id=<?= $category['id'] ?>"
                       class="btn btn-secondary"><?= $category['title'] ?></a>
                    <h1 class="mt-2"><a href="<?= ROOT_URL ?>single.php?id=<?= $featured['id'] ?>"
                                        class="posts-link link-secondary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover"><?= $featured['title'] ?></a>
                    </h1>
                    <p class="mt-3"><?= add3dots($featured['body'], "...", 300) ?></p>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="px-3">
                                ...
                                <p class="card-text"><small
                                            class="text-muted"><?= strftime("%d %B, %Y - %H:%M", strtotime($featured['date_time'])) ?></small>
                                </p>
                            </div>
                        </div>
                    </div>
